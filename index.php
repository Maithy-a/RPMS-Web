    ...
    <div class="home-container">
      <div class="slider-container">
        ...
        <div class="slide " id="slide2">
          <div class="image-container">
            <img src="res/img/parking-2.png" alt="Spacious Rooms">
          </div>
          <div class="text-box">
            <h2>Spacious Rooms</h2>
            <p>Step into the heart of Elsie Executive Apartments and experience the magic of our open kitchen design!
              I absolutely love how it perfectly blends modern style with practical functionality, giving me the ideal
              space for all my culinary adventures. The spacious layout flows effortlessly into the living area,
              creating a warm and inviting vibe that’s perfect for socializing. With sleek countertops, premium
              appliances, and plenty of natural light, every moment in the kitchen feels like a joy. It’s not just a
              kitchen—it’s where creativity thrives, memories are made, and connections happen. Come see why it’s the
              centerpiece of life at Elsie Executive Apartments!</p>
            <a href="#" class="home-btn">Read More <i class="bi bi-box-arrow-in-up-right"></i></a>
          </div>
        </div>
        <div class="slide " id="slide3">
          <div class="image-container">
            <img src="res/img/house.jpg" alt="Spacious Rooms">
          </div>
          <div class="text-box">
            <h2>Spacious Rooms</h2>
