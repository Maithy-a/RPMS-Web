    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-2 text-gray-800">Your Contract</h1><br />
          <p class="mb-4">Please contact the system administrator for any changes concerning your contract. Thank
            you!<br /><br /><b>Phone Number: +254 (0) 756 777 777.<br />Email Address: rhms123@hotmail.com.</p>
        </div>
        <!-- /.container-fluid -->
